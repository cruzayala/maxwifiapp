...
function createMobileRouter({ prisma, loginLimiter, billing, provisionClient, queryIpam, reserveIp, releaseIp, whatsappStatus, sendWhatsapp, clientAction, externalClient, ticketProvider, liveNetwork, mikrotikOverview, mikrotikPing }) {
  ...
  require('./mobile-network').registerMobileNetwork(router, { prisma, wrap, permission, pagination, positiveId, searchWhere, liveNetwork, mikrotikOverview, mikrotikPing });
