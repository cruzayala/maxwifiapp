// Generated from shared/invoice-renderer.ts; run npm run build:documents.
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.InvoiceRenderer = void 0;
/** Pure renderer shared by Angular and the mobile document endpoint. */
class InvoiceRenderer {
    size;
    cfg;
    constructor(company, size = '80mm') {
        this.size = size;
        this.cfg = {
    ...
    paperSize() { return this.size; }
    generateInvoiceHTML(inv, forPrint = false) {
...
<body>
  ...
  ${printScript}
    ...
    generateReceiptHTML(inv, forPrint = false) {
        const company = this.escape(this.cfg.companyName());
        const slogan = this.escape(this.cfg.companySlogan());
        const phone = this.escape(this.cfg.companyPhone());
        const address = this.escape(this.cfg.companyAddress());
...
<body>
  ...
  ${printScript}
    ...
    formatDate(value) {
        if (!value)
            return '-';
        // A billing calendar date is not a UTC instant.
...
exports.InvoiceRenderer = InvoiceRenderer;
