...
const BUILTIN_ONU_MODEL_PROFILES = Object.freeze([
  ...
  },
  {
    ...
    defaults: { vlan: 101, wanMode: 'static', dataModel: 'InternetGatewayDevice' },
    notes: 'Huawei HS8545M5 (1GE + 3FE + telefono + WiFi 2.4 GHz). Mismo panel V5R019 que la EG8141A5; el acceso remoto usa Precise Device Access Control. Pendiente de certificar en campo.',
    capabilities: [
