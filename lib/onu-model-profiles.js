...
const BUILTIN_ONU_MODEL_PROFILES = Object.freeze([
  ...
  {
    profileKey: 'huawei-hs8545m5-v5r019', manufacturer: 'Huawei', model: 'HS8545M5',
    firmwarePattern: 'V5R019*', serialPrefixes: ['HWTC'], ponType: 'GPON',
    oltVendor: 'ZTE', oltModel: 'C320', oltOnuType: 'HG8546M', omciMode: 'baseline',
    extendedOmci: false, tr069ProfileKey: 'huawei-hs8545m5-v5r019',
    // Certificada en campo el 24/09/2026 con ONU Studio (dos instalaciones completas y
    // verificadas). Las capacidades por OMCI/TR-069 siguen como detectadas: aun no se probaron.
    certificationStatus: 'verified', builtIn: true,
    defaults: { vlan: 101, wanMode: 'static', dataModel: 'InternetGatewayDevice' },
    notes: 'Huawei HS8545M5 (1GE + 3FE + telefono + WiFi 2.4 GHz). Mismo panel V5R019 que la EG8141A5; el acceso remoto usa Precise Device Access Control. Instalacion completa certificada en campo con ONU Studio.',
    capabilities: [
      capability('olt_provision', 'OLT_CLI', 'detected'), capability('optical_read', 'OMCI', 'detected'),
      capability('equipment_read', 'OMCI', 'detected'), capability('service_read', 'OMCI', 'detected'),
      capability('ethernet_read', 'OMCI', 'detected'), capability('wifi_read', 'TR069', 'detected'),
      capability('wifi_write', 'TR069', 'detected'), capability('lan_read', 'TR069', 'detected'),
      capability('lan_write', 'TR069', 'detected'), capability('wan_read', 'TR069', 'detected'),
      capability('wan_write', 'TR069', 'blocked'), capability('diagnostics', 'TR069', 'detected'),
      capability('reboot', 'OMCI', 'detected'), capability('factory_reset', 'TR069', 'blocked'),
      capability('firmware_upgrade', 'TR069', 'blocked'), capability('acs_config', 'TR069', 'blocked'),
      capability('security_config', 'TR069', 'blocked'),
    ],
  },
