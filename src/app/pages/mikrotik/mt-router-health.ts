...
@Component({
  ...
  styles: [`
    ...
    .semaphore.ok { color: #13875a; background: #e9f8f1; }
    .semaphore.warn { color: #b36b12; background: #fff6e8; }
    .semaphore.crit { color: #b42318; background: #fff0ef; }
    .semaphore.none { color: #667582; background: #eef1f5; }
    .empty { display: flex; align-items: center; gap: 10px; padding: 22px 16px; color: #667582; font-size: 12px; }
    ...
    .gauge .track { stroke: #e9edf2; }
    .gauge .fill { stroke: #2b7c9f; stroke-linecap: round; transition: stroke-dasharray .4s ease; }
    .gauge.ok .fill { stroke: #13875a; }
    .gauge.warn .fill { stroke: #d08a1c; }
    .gauge.crit .fill { stroke: #b42318; }
    .gauge strong { position: absolute; top: 30px; left: 0; right: 0; color: #172535; font-size: 15px; line-height: 1; }
    .gauge span { margin-top: 4px; color: #334250; font-size: 12px; font-weight: 700; }
    .gauge small { max-width: 100%; color: #667582; font-size: 11px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
    .gauge.warn span { color: #b36b12; }
    .gauge.crit span { color: #b42318; }
    .reasons { margin: 8px 14px 0; padding: 8px 10px; list-style: none; border-radius: 6px; background: #fff6e8; }
    ...
    .sensor { display: inline-flex; align-items: center; gap: 5px; min-height: 26px; padding: 0 8px; border: 1px solid #dfe5ea; border-radius: 6px; color: #334250; font-size: 12px; }
    .sensor em { color: #667582; font-style: normal; }
    ...
    .note { margin: 10px 14px 0; color: #667582; font-size: 11px; }
    ...
    .facts dt { display: flex; align-items: center; gap: 4px; color: #667582; font-size: 11px; font-weight: 650; }
    .facts dd { margin: 2px 0 0; color: #172535; font-size: 12px; font-weight: 700; overflow-wrap: anywhere; }
