...
@Component({
  ...
  styles: [`
    ...
    .eyebrow { display: block; color: #1267dd; font-size: 11px; font-weight: 800; letter-spacing: .08em; text-transform: uppercase; margin-bottom: 6px; }
    h2, h3, p { margin: 0; }
    h2 { color: #172535; font-size: 24px; letter-spacing: 0; }
    .page-heading p { color: #667582; font-size: 14px; margin-top: 7px; }
    .btn { display: inline-flex; align-items: center; justify-content: center; gap: 8px; border: 0; border-radius: 6px; min-height: 42px; padding: 0 16px; font-size: 13px; font-weight: 700; cursor: pointer; transition: .2s ease; }
    ...
    .summary-item { background: white; border: 1px solid #dfe5ea; border-radius: 8px; padding: 17px 19px; }
    .summary-label, .summary-note { display: block; color: #64748b; font-size: 12px; }
    .summary-item strong { display: block; color: #172535; font-size: 22px; line-height: 1.1; margin: 8px 0 4px; }
    .summary-item strong.green { color: #13875a; }.summary-item strong.blue { color: #1267dd; }
    .table-panel { background: white; border: 1px solid #dfe5ea; border-radius: 8px; overflow: hidden; }
    ...
    .panel-toolbar h3 { color: #0f172a; font-size: 15px; }.toolbar-note { display: block; color: #667582; font-size: 12px; margin-top: 4px; }
    ...
    .search-field:focus-within { border-color: #1267dd; box-shadow: 0 0 0 3px rgba(18,103,221,.12); }.search-field svg { width: 16px; height: 16px; fill: none; stroke: currentColor; stroke-width: 2; stroke-linecap: round; }
    .search-field input { width: 100%; border: 0; outline: 0; background: transparent; color: #334155; font-size: 13px; }
    .table-wrap { overflow-x: auto; } table { width: 100%; border-collapse: collapse; min-width: 760px; } th, td { text-align: left; padding: 14px 22px; border-bottom: 1px solid #f1f5f9; } th { color: #64748b; font-size: 11px; text-transform: uppercase; letter-spacing: .06em; font-weight: 800; background: #fafbfc; } td { color: #334155; font-size: 13px; vertical-align: middle; } tbody tr:last-child td { border-bottom: 0; } tbody tr:hover { background: #f8fafc; }.actions-heading { text-align: right; }
    .user-cell { display: flex; align-items: center; gap: 11px; min-width: 240px; }.user-cell strong, .user-cell span { display: block; }.user-cell strong { color: #0f172a; font-size: 13px; }.user-cell span { color: #667582; font-size: 12px; margin-top: 3px; }.avatar { display: grid; place-items: center; width: 34px; height: 34px; border-radius: 8px; color: #1267dd; background: #edf4ff; font-weight: 800; font-size: 11px; flex: 0 0 auto; }
    .role-badge, .status-badge { display: inline-flex; align-items: center; gap: 6px; border-radius: 999px; padding: 5px 9px; font-size: 11px; font-weight: 700; white-space: nowrap; }.role-badge { color: #475569; background: #f1f5f9; }.role-badge.super { color: #0d58c0; background: #edf4ff; }.status-badge.active { color: #13875a; background: #e9f8f1; }.status-badge.inactive { color: #b42318; background: #fff0ef; }.status-dot { width: 6px; height: 6px; border-radius: 50%; background: currentColor; }.last-login { color: #64748b; white-space: nowrap; }.row-actions { display: flex; justify-content: flex-end; gap: 5px; }.icon-btn, .close-btn { display: inline-grid; place-items: center; border: 0; background: transparent; color: #64748b; cursor: pointer; border-radius: 7px; }.icon-btn { width: 32px; height: 32px; }.icon-btn:hover { background: #edf4ff; color: #1267dd; }.icon-btn.danger:hover { background: #fff0ef; color: #b42318; }.icon-btn svg, .close-btn svg { width: 16px; height: 16px; fill: none; stroke: currentColor; stroke-width: 1.8; stroke-linecap: round; stroke-linejoin: round; }
    .state-panel { display: grid; place-items: center; text-align: center; padding: 56px 20px; color: #64748b; }.state-panel h3 { color: #334155; font-size: 16px; margin-top: 10px; }.state-panel p { font-size: 13px; margin-top: 5px; }.state-panel.compact { padding: 46px 20px; }.error-state { background: white; border: 1px solid #fecaca; border-radius: 12px; }.state-icon { display: grid; place-items: center; width: 34px; height: 34px; border-radius: 50%; color: #b91c1c; background: #fee2e2; font-weight: 900; }.muted-icon { color: #64748b; background: #f1f5f9; }.spinner { width: 22px; height: 22px; border: 3px solid #dfe5ea; border-top-color: #1267dd; border-radius: 50%; animation: spin .8s linear infinite; } @keyframes spin { to { transform: rotate(360deg); } }
    .modal-backdrop { position: fixed; inset: 0; z-index: 300; display: grid; place-items: center; padding: 20px; background: rgba(15,23,42,.48); backdrop-filter: blur(3px); }.modal { width: min(560px, 100%); max-height: calc(100vh - 40px); overflow-y: auto; background: white; border-radius: 8px; box-shadow: 0 24px 80px rgba(15,23,42,.25); }.modal-header { display: flex; align-items: flex-start; justify-content: space-between; padding: 22px 24px 16px; border-bottom: 1px solid #e2e8f0; }.modal-header h3 { color: #0f172a; font-size: 19px; }.close-btn { width: 32px; height: 32px; }.close-btn:hover { background: #f1f5f9; color: #0f172a; }.modal form { padding: 20px 24px 24px; }.modal-copy { color: #64748b; font-size: 13px; margin-bottom: 18px; }.form-row { display: grid; grid-template-columns: 1fr 1fr; gap: 14px; }.form-field { display: block; margin-bottom: 15px; }.form-field span, .toggle-field strong { display: block; color: #475569; font-size: 12px; font-weight: 700; margin-bottom: 6px; }.form-field input, .form-field select { width: 100%; height: 40px; border: 1px solid #cbd5e1; border-radius: 8px; padding: 0 11px; color: #334155; background: white; outline: 0; font: inherit; font-size: 13px; }.form-field input:focus, .form-field select:focus { border-color: #1267dd; box-shadow: 0 0 0 3px rgba(18,103,221,.12); }.form-field select:disabled { background: #f8fafc; color: #94a3b8; }.form-field small, .toggle-field small { display: block; color: #667582; font-size: 11px; margin-top: 5px; }.form-field small.warn { color: #b36b12; }.toggle-field { display: flex; align-items: center; gap: 10px; padding-top: 23px; cursor: pointer; }.toggle-field input { width: 17px; height: 17px; accent-color: #1267dd; }.toggle-field strong { margin: 0; color: #334155; }.account-reference { display: flex; justify-content: space-between; align-items: center; padding: 11px 13px; background: #f8fafc; border-radius: 8px; margin-bottom: 15px; font-size: 13px; }.account-reference span { color: #64748b; }.account-reference strong { color: #0f172a; }.modal-actions { display: flex; justify-content: flex-end; gap: 9px; padding-top: 8px; margin-top: 4px; border-top: 1px solid #f1f5f9; }
    .pass-wrap { position: relative; }.pass-wrap input { padding-right: 40px !important; }.eye-btn { position: absolute; right: 4px; top: 50%; transform: translateY(-50%); width: 32px; height: 32px; display: grid; place-items: center; background: none; border: 0; border-radius: 6px; color: #667582; cursor: pointer; }.eye-btn:hover { background: #f2f7ff; color: #1267dd; }
    .you-tag { font-style: normal; font-size: 11px; font-weight: 700; color: #1267dd; background: #edf4ff; border-radius: 999px; padding: 1px 7px; margin-left: 6px; }
    .self-warn { margin: 0 0 12px; padding: 9px 12px; border-radius: 6px; background: #fff6e8; color: #8a5410; font-size: 12px; }
    .form-hint { margin: 0 0 10px; font-size: 12px; color: #667582; }
