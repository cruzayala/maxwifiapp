...
@Component({
  ...
  styles: [`
    ...
    .chip { flex: 0 0 auto; min-height: 32px; display: inline-flex; align-items: center; gap: 7px; padding: 0 10px; border: 1px solid #cfd8d2; border-radius: 16px; background: #fff; color: #2d3b34; font: inherit; font-size: 12px; font-weight: 650; cursor: pointer; white-space: nowrap; }
    .chip:hover { border-color: #9fb3c2; background: #f4f6f2; }
    .chip:focus-visible { outline: 2px solid #0b6b52; outline-offset: 1px; }
    .chip b { min-width: 20px; height: 20px; display: inline-grid; place-items: center; padding: 0 6px; border-radius: 10px; background: #eef2f5; color: #2d3b34; font-size: 11px; }
    .chip.tone-danger b { background: #fff0ef; color: #b42318; }
    .chip.tone-warning b { background: #fff6e8; color: #b36b12; }
    .chip.tone-info b { background: #e6f2ec; color: #0b6b52; }
    .chip.tone-success b { background: #e9f8f1; color: #0f7a53; }
    .chip.active { border-color: #0b6b52; background: #e6f2ec; color: #08523f; }
    .chip.active b { background: #0b6b52; color: #fff; }
  `],
})
